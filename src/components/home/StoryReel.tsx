    ...
    >
      ...
      <div className="relative flex w-full flex-col md:flex-row md:items-stretch">
        {buildStages.map((scene, index) => (
          <article
            key={scene.id}
            className="story-panel relative flex min-h-[58vh] w-full flex-shrink-0 flex-col justify-center py-12 md:min-h-[64vh] md:w-screen md:py-16"
          >
            <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col justify-between px-5 md:px-8">
              <div className="flex items-start justify-between gap-6">
                <p className="mono text-[11px] text-bg-mist/50">
                  Phase {scene.id}
                </p>
              ...
              <div className="relative flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between md:gap-12 lg:gap-16">
